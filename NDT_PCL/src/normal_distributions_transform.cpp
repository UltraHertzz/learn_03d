...
// Function for visualizing the point clouds
void visualizer_thread(pcl::PointCloud<pcl::PointXYZ>::Ptr target_cloud, pcl::PointCloud<pcl::PointXYZ>::Ptr output_cloud)
{
...
int main()
{
  ...
  ndt.setMaximumIterations(35);  // Setting max number of registration iterations.
  ...
  std::thread visualizer(visualizer_thread, target_cloud, output_cloud);
  visualizer.join();
